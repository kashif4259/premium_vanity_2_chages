                            ...
                            <div v-if="orderType === 'sales'" class="form-group row ml-0">
                                ...
                                <div class="col-4 col-sm-6 col-md-7 col-lg-8 col-xl-8 pl-0">
                                    <select     v-validate="'required'"
                                            ...
                                            <option value="delivery"  :selected="edit_order_details.delivery_or_pickup == 'delivery'" >Delivery</option>
                                            <option value="pickup"  :selected="edit_order_details.delivery_or_pickup == 'pickup'">Pickup</option>
                                        </select>
...
import PaymentDetailsMixin from "../mixin/EditOrUpdateOrderPaymentDetailsMixin";
